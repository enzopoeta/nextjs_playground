...
import ParentComponent from '../../components/direct_communicaton/Parent';

// converncao de nome do componente igual ao java
const ComponentDirectComm = function () { // o nome do arquivo nao precisa ser o mesmo da funcao
...
export default ComponentDirectComm